                ...
                <form action="/update/{{ $task->id }}" method="POST">
                    ...
                    <div class="row g-3"> 
                        <div class="col-12">
                            ...
                            <input type="text" id="task-name" name="task_name" class="form-control" value="{{old('task_name', $task->task_name)}}">
                            @error('task_name')
                        ...
                        <div class="col-12">
                            ...
                            <select id="priority" class="form-select" name="priority">
                                ...
                                <option value="1" {{ old('priority', $task->priority) == '1' ? 'selected' : '' }}>Drag and drop task items to sort the priority level</option>
                            </select>
                            @error('priority')
                    ...
                    <div class="d-flex float-end">
                        <button class="btn btn-success custom-btn mt-4" type="submit">Edit task</button>
